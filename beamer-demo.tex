\documentclass[aspectratio=169,fontpreset=common,theme=cobalt,layout=splitbar]{maki-beamer}
...
\begin{frame}[t]{为什么把 Beamer 接进 maki-notes}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{alertblock}{设计取向}
      这一套 Beamer 支持把 \texttt{beamer-example/} 里的 Durham 风格沉淀成默认 \texttt{layout=durham}, 并额外补了 \texttt{minimal} 与 \texttt{splitbar}; 主题色、数学块和图形语义继续复用 \texttt{maki-notes.sty}.
    \end{alertblock}
