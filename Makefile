...
TEST_DOCS := tests/test-basic.tex tests/test-environments.tex tests/test-graphics.tex tests/test-tikz-styles.tex
TEST_NAMES := test-basic test-environments test-graphics test-tikz-styles
