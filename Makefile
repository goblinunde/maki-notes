...
TEST_DOCS := tests/test-basic.tex tests/test-beamer.tex tests/test-environments.tex tests/test-graphics.tex tests/test-tikz-styles.tex tests/test-wrap-layout.tex tests/test-workflow-guide.tex tests/test-research-workflow.tex tests/test-solutions-inline.tex tests/test-solutions-appendix.tex tests/test-reference-helpers.tex
TEST_NAMES := test-basic test-beamer test-environments test-graphics test-tikz-styles test-wrap-layout test-workflow-guide test-research-workflow test-solutions-inline test-solutions-appendix test-reference-helpers
